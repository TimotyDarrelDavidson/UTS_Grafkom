/**
 * Generate Trapinch Leg Tip - Small Ellipsoid (rounded foot)
 * @param {number} rx - Radius in X direction
 * @param {number} ry - Radius in Y direction
 ...
 */
export function generateTrapinchLegTip(rx, ry, rz, latBands, longBands, color) {
    var vertices = [];
    var faces = [];
